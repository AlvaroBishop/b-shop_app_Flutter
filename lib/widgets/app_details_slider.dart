                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: const [
                                  Text("100K reviews", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white),),
                                  SizedBox(width: 2,),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: const [
                                  Text("Downloads", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white),),
